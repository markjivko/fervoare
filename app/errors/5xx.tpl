...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en">
    <head>
        ...
        <title><?php echo t2(__FILE__,5,'Server error').' '.$info->no;?> - <?php echo $info->errors[$info->no];?></title>
    </head>
    <body>
        <div id="main-wrapper">
            <div id="error">
                <div id="logo"><a href="/" target="_blank" title="Fervoare CMS">Fervoare CMS</a></div>
                <h1><?php echo t2(__FILE__,5,'Server error').' '.$info->no;?> - <?php echo $info->errors[$info->no];?></h1>
                <hr/>
                <?php print t2(__FILE__,6,'The server has encountered a problem.');?><br/><?php echo $info->message;?>
                <hr/>
                <?php 
